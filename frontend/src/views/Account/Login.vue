          ...
          <v-card tile class="pa-9" height="650px" align="center">
            ...
            <div style="display: table; width: 95%; border: 1px solid #ccc; padding: 30px 47px">
              <div style="display: table-cell; width: 45%;position: relative;">
                <div style="font-size: 22px; color: #222; text-align: left; position: absolute; top: 35%; color: #777">
                  아직 회원이 아니신가요?
                </div>
              </div>
              <div style="display: table-cell; width: 45%;">
                ...
                <div style="padding-bottom: 20px; text-align: center; ">
                  <v-btn @click="toRegister()" style="color: #777; width: 50%; border: 1px solid #282d41; background: #fff; font-size: 14px; font-weight: 500; padding: 8px 35px; border-radius: 25px;">
                    <v-icon style="margin-right: 5%; color: #777">
